...
import "../../index.css"
import user from "../../assets/images/avatar/Marley.jpg";
        ...
        <div className="">
            <div className="align-items-center d-flex justify-content-between statut ">
                ...
                <div className="breadcrumb d-flex mb-4">
                    ...
                    <li className="breadcrumb-item lien2" onClick={users}>Utilisateur</li>
            ...
            <form className="form mt-2 monprofil">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="align-items-center d-flex">
                            ...
                            <p className="nomEntreprise">
                                ...
                                <div className="imgg">
                                    <label htmlFor="profil_img" className="custom-file-upload">
                    ...
                    <div className="col-md-6">
                        <div className="align-items-center d-flex">
                            ...
                            <p className="nomEntreprise">
                                <p className="fs-5 ">Marley Apong<br />
                                    <p className="email_en text-success">marleyapong@gmail.com</p>
                                </p>
                                <div className="imgg">
                                    ...
                                    <input type="file" id="profil_img" className="input-file no-focus-outline" />
                                </div>
                            </p>
                        </div>
                    </div>
                ...
                <textarea name="description" id="" className="form-control no-focus-outline fs-5 mb-3 mt-2 texaria"></textarea>
            ...
            <form className="form monprofil">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="new_new" className="mb-1 ">Nouvaeau mot de passe</label>
                            ...
                            <div className="password-icon" onClick={toggleNewPasswordVisibility}>
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            ...
                            <div className="password-confirm" onClick={toggleConfirmPasswordVisibility}>
